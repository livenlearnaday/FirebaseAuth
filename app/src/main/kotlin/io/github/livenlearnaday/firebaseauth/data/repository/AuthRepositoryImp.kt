...
class AuthRepositoryImp(
    ...
    override suspend fun fetchCredential(context: Context): Response<Credential> {
        return try {
    ...
    override suspend fun signInWithGoogle(credential: Credential): Response<AuthResult> {
    ...
    override suspend fun deleteUserAccount(credential: Credential?): Response<Boolean> {
        return try {
            when (credential) {
                // GoogleIdToken credential
                is CustomCredential -> {
    ...
    override suspend fun loginWithEmailAndPassword(authRequestModel: AuthRequestModel): Response<Boolean> {
        return try {
    ...
    override suspend fun signUpWithEmailAndPassword(authRequestModel: AuthRequestModel): Response<Boolean> {
        return try {
